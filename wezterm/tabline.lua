...
--local nodeVersion = wezterm.run_child_process { "node --version" }
--local nodeVersion, stdout, stderr = wezterm.run_child_process({ os.getenv("SHELL"), "-c", "node --version" })
...
tabline.setup({
	sections = {
		...
		tab_active = {
			...
			{ "zoomed", padding = 0 }, --{ "process", padding = { left = 0, right = 1 } } },
		},
	},
	options = {
		icons_enabled = true,
