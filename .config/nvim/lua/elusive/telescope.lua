...
local function set_background(content)
	vim.fn.system(":silent exec reg add \"HKEY_CURRENT_USER\\Control Panel\\Desktop\" /v Wallpaper /t REG_SZ /d " .. content .. " /f")
	vim.fn.system(":silent exec RUNDLL32.EXE user32.dll,UpdatePerUserSystemParameters")
end
...
M.bg_selector = image_selector("< Anime Bobs > ", "~/OneDrive - Lionsgate Entertainment/Pictures/wallpaper")
